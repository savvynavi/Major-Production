...
////// Lighting:
////// Emissive:
                float4 node_930 = _Time;
                float2 node_4964 = (i.uv0+node_930.g*float2(1,1));
                float4 _DissolveTexture_var = tex2D(_DissolveTexture,TRANSFORM_TEX(node_4964, _DissolveTexture));
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float3 node_4290 = (i.vertexColor.a*(i.vertexColor.rgb*_MainTex_var.r));
