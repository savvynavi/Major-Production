    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_4333 = ((_CloudClipSize*i.uv0)+node_9838.g*float2(0.1,0.1));
...
////// Emissive:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                float4 node_6620 = _Time;
                float2 node_4333 = ((_CloudClipSize*i.uv0)+node_6620.g*float2(0.1,0.1));
                float4 _AlphaMap_var = tex2D(_AlphaMap,TRANSFORM_TEX(node_4333, _AlphaMap));
                clip((((1.0 - i.uv0.b)*2.0+-1.0)+(_AlphaMap_var.r+_AlphaMap_var.b)) - 0.5);
