    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_394 = (_DistortionSpeed*node_7558.g);
                ...
                float2 node_7930 = (i.uv0+(((i.uv0.g*_FireShape_var.a)*1.0)*(saturate((_FireMasks2_var.b+_FireMasks2_var.b))*_DistortionFactor)));
